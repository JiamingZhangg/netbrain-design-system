...
export declare function buildSearchQuery(owner: string, project: string, commits: IExtendedCommit[]): string | undefined;
/**
...
export default class Release {
    ...
    constructor(git: Git, options?: IAutoConfig, logger?: ILogger);
    /**
    ...
    addLabelsToProject(labels: Partial<ILabelDefinitionMap>, options?: ICreateLabelsOptions): Promise<void>;
    /**
