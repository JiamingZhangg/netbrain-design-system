...
(function (factory) {
    ...
    var JSONCompletion = /** @class */ (function () {
        ...
        JSONCompletion.prototype.doComplete = function (document, position, doc) {
            ...
            var supportsCommitCharacters = this.doesSupportsCommitCharacters();
            var proposed = {};
            var collector = {
                add: function (suggestion) {
                    ...
                    if (!existing) {
                        ...
                        if (supportsCommitCharacters) {
                            suggestion.commitCharacters = suggestion.kind === vscode_languageserver_types_1.CompletionItemKind.Property ? propertyCommitCharacters : valueCommitCharacters;
                        }
